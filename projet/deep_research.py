...
def deep_research(query, n_results, k_pick, progress_callback=None):
    ...
    if not tasks:
        print("❌ Aucune URL valide à scraper. Fin du programme.")
        progress_callback(100, "❌ Aucune URL valide à scraper.")
        return
...
"""
    ...
    if not validated_summaries:
        print("\n❌ La validation des documents n'a pas abouti. Fin du programme.")
        progress_callback(100, "❌ La validation des documents n'a pas abouti.")
        return
